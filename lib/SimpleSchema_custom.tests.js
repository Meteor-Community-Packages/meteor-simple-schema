...
describe('custom', function () {
    ...
    it('we do not get required errors for a required field that has a `custom` function when we are $setting', async function () {
    ...
    it('we do not get required errors for a required field that has a `custom` function when we are $pushing', async function () {
        const context = requiredCustomSchema.namedContext()
        expect((await context.validate({
                $push: {
                    a: {}
