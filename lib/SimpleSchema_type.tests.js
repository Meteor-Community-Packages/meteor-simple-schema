...
describe('SimpleSchema - type', function () {
  ...
  it('array of objects', async function () {
  ...
  describe('custom type', function () {
    it('valid', async function () {
      ...
      (await expectErrorOfTypeLength(SimpleSchema.ErrorTypes.EXPECTED_TYPE, schema, {
        createdAt: new Date(),
  ...
  describe('string', function () {
    ...
    it('modifier with $setOnInsert', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
    ...
    it('modifier with $set', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
    ...
    it('modifier with $push', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
    ...
    it('modifier with $addToSet', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
    ...
    it('modifier with $push + $each', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
  ...
  describe('date', function () {
    ...
    it('modifier with $currentDate', async function () {
      (await expectErrorOfTypeLength(
          SimpleSchema.ErrorTypes.EXPECTED_TYPE,
          testSchema,
          {
  ...
  describe('array', function () {
    ...
    it('sparse arrays', async function () {
      const schema = new SimpleSchema({
        sparse: Array,
        'sparse.$': {
          type: String,
    ...
    it('ignores slice', async function () {
      (await expectErrorLength(
          testSchema,
          {
            $push: {
    ...
    it('ignores pull', async function () {
      (await expectErrorLength(
          testSchema,
          {
            $pull: {
    ...
    it('ignores pull + $each', async function () {
      (await expectErrorLength(
          testSchema,
          {
            $pull: {
    ...
    it('ignores pullAll', async function () {
      (await expectErrorLength(
          testSchema,
          {
            $pullAll: {
