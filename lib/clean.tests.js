...
describe('clean', function () {
    ...
    it('trim strings', async function () {
        ...
        // $UNSET is ignored
        await doTest(true, {$unset: {string: '    This is a string    '}},
            {$unset: {string: '    This is a string    '}});

        // $SETONINSERT
        await doTest(true, {$setOnInsert: {string: '    This is a string    '}},
            {$setOnInsert: {string: 'This is a string'}});
        ...
        // $PUSH
        await doTest(true, {$push: {minMaxStringArray: '    This is a string    '}},
            {$push: {minMaxStringArray: 'This is a string'}});
        ...
        // $PULL
        await doTest(true, {$pull: {minMaxStringArray: '    This is a string    '}},
            {$pull: {minMaxStringArray: 'This is a string'}});

        // $POP
        await doTest(true, {$pop: {minMaxStringArray: '    This is a string    '}},
            {$pop: {minMaxStringArray: 'This is a string'}});
