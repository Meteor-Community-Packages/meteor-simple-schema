...
doValidation = function doValidation(obj, isModifier, isUpsert, keysToValidate, ss, extendedCustomContext, ignoreTypes) {
  ...
  function checkObj(val, affectedKey, operator, setKeys, isInArrayItemObject, isInSubObject) {
    ...
    if (affectedKey) {
      ...
      if (shouldValidateKey) {
        ...
        let skipRequiredCheck = _.some(setKeys, function(sk) {
    ...
    // Loop through object keys
      ...
      let keysToCheck = _.union(presentKeys, ss.objectKeys(affectedKeyGeneric));
