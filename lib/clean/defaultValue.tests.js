...
describe('defaultValue', function () {
    describe('normal objects', function () {
        ...
        it('adds defaultValue for prop in objects within array, if object is set in object being cleaned',
            async function () {
                const schema = new SimpleSchema({
                    b: {
                        type: Array,
        ...
        it('does not add defaultValue for prop in objects within array, if the prop is already set in object being cleaned',
            async function () {
                const schema = new SimpleSchema({
                    b: {
                        type: Array,
        ...
        it('adds defaultValue for prop in objects within array, if array and object are set by array defaultValue',
            async function () {
                const schema = new SimpleSchema({
                    b: {
                        type: Array,
        ...
        it('does not add defaultValue for prop in object, if prop already has value in object being cleaned',
            async function () {
                const schema = new SimpleSchema({
                    a: {
                        type: Object,
